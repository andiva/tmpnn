...
class TaylorMap(Layer):
    ...
    def __init__(self, output_dim, order=1, weights_regularizer = tf.keras.regularizers.L1(0), **kwargs):
    ...
    def call(self, x, mask=None):
        ...
        eigs = math.sigmoid(math.real(linalg.eigvals(self.W[1] + K.dot(sx, self.W[2]))))
        self.add_loss(self.weights_regularizer(eigs))
